        ...
        return summaryResult.fold<Widget>(
          ...
          (summary) => StaggeredGridView.count(
            ...
            children: <Widget>[
              SummaryTile(
                title: 'Total Queries',
                subtitle: '${_numberFormat.format(summary.dnsQueriesToday)}',
                color: Colors.green,
              ),
              SummaryTile(
                title: 'Queries Blocked',
                subtitle: '${_numberFormat.format(summary.adsBlockedToday)}',
                color: Colors.blue,
              ),
              SummaryTile(
                title: 'Percent Blocked',
                subtitle: '${summary.adsPercentageToday.toStringAsFixed(2)}%',
                color: Colors.orange,
              ),
              SummaryTile(
